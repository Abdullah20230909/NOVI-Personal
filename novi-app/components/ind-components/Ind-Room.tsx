...
const IndRoom = ({initialVideoEnabled = true, initialAudioEnabled = true }: IndRoomProps = {}) => {
    ...
    // Single distraction counter: counts consecutive seconds of DISTRACTED, resets on FOCUSED
            ...
            if (videoRef.current && isVideoEnabled) {
                ...
                if (width > 0 && height > 0) {
                    ...
                    if (result && (result.status === "FOCUSED" || result.status === "DISTRACTED")) {
                        ...
                        // Store latest detection data for distraction posting
                        latestDistractionDataRef.current = result;
    ...
    return (
        <div className="fixed inset-0 flex flex-col w-full bg-gray-50 dark:bg-gray-900 transition-colors duration-300 z-[60]">
                ...
                <div className={`flex items-center justify-center transition-all duration-300 ${
                    ...
                    <div className="relative w-full max-w-6xl rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800 transition-colors duration-300" style={{ aspectRatio: '16/9' }}>
                        {isVideoEnabled ? (
                            <video
                                ref={videoRef}
                                autoPlay
