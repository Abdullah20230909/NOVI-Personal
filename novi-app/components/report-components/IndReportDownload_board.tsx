        ...
        <div className="flex flex-col flex-1 animate-fade-in w-full">
            ...
            <div className="bg-white rounded-[24px] p-8 shadow-sm border-2 border-[#06b6d4] w-full">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-3xl font-black text-[#06b6d4] tracking-tight">Archived Individual Sessions</h2>
            ...
            {loading && (
                <div className="mt-6 text-[#0284c7] font-bold animate-pulse text-center py-16">Loading individual sessions...</div>
            )}
                        ...
                        <div key={index} className="bg-[#06b6d4] rounded-[20px] p-6 shadow-sm flex items-center justify-between w-full">
                            <div className="flex flex-col gap-3 flex-1">
                                ...
                                <div className="bg-white rounded-xl px-5 py-3 max-w-[550px]">
                                    <span className="text-[#06b6d4] font-bold text-sm">Session ID: <span className="font-semibold text-[#0284c7]">{session.session_id}</span></span>
                                </div>
