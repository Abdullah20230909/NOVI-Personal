        ...
        <div className="absolute inset-0 top-[112px] flex text-zinc-800 animate-fade-in bg-[#ecfeff]">
            ...
            <div className="w-[280px] bg-[#fbf9fe] border-r border-[#e8ddef] flex flex-col p-6 pt-10 justify-between">
                <div>
                    ...
                    <div className="flex items-center gap-3 mb-10 pl-2">
                        <div className="bg-[#06b6d4] p-2 rounded-xl text-white shadow-sm flex items-center justify-center">
                            <FileText size={24} strokeWidth={2.5} />
                        </div>
                        <h1 className="text-xl font-bold text-[#06b6d4] tracking-tight">Novi Analytics</h1>
                    </div>

                    {/* Back Navigation Button */}
                    <button 
                        onClick={onBack}
                        className="text-sm text-[#06b6d4] font-medium hover:text-[#06b6d4]/80 transition-colors flex items-center gap-2 mb-10 pl-2"
                    >
                        &larr; Back to Home
                    </button>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <button
                            ...
                            className={`px-5 py-4 rounded-2xl text-left transition-all duration-200 flex items-center gap-4 font-bold ${
                                activeTab === 'summary' 
                                ? 'bg-white text-[#06b6d4] shadow-sm shadow-[#06b6d4]/10 border-2 border-[#06b6d4]' 
                                : 'text-[#8ba3b8] hover:bg-white/50 hover:text-[#06b6d4]'
                            }`}
                        >
                            <LayoutGrid size={20} strokeWidth={2.5} className={activeTab === 'summary' ? 'text-[#06b6d4]' : ''} />
                            Overview
                        </button>
                ...
                <div className="bg-[#06b6d4] rounded-[24px] p-5 text-white shadow-lg relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col px-10 pb-8 pt-10 overflow-y-auto hidden-scrollbar">
                ...
                <div className="flex flex-col mb-6">
                    <h2 className="text-2xl font-black text-[#06b6d4]">{new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</h2>
                </div>
